...
public class CharcoalForHaunchyTest extends ZonePlayerAndNPCTestImpl {
	...
	public void testQuest() {
		...
		haunchyEng.step(player, "charcoal");
		assertEquals("Charoal isn't easy to find. You normally can find it somewhere in the ground but perhaps you are lucky and find some in the old Semos Mine tunnels...", getReply(haunchy));
		haunchyEng.step(player, "yes");
		assertEquals("Thank you! If you have found 25 pieces, say #coal or #charcoal to me so I know you have it. I'll be sure to give you a nice and tasty reward.", getReply(haunchy));
		haunchyEng.step(player, "charcoal");
